...
public class ImageMetadataDrewMetadataExtractor extends HttpTest
{
    ...
    public void setup() throws Exception
    {
        ...
        imageConfigProxy.setMetadataLibrary(ImageConfigMBeanImpl.DREW_METADATA_EXTRACTOR);
    ...
    public void testMetadata() throws ServletException, IOException, Exception
    {
        ...
        Assert.isTrue(((JsonNode) root.get("ICC Profile")) != null);
        Assert.isTrue(((JsonNode) root.get("Jfif")) != null);
        Assert.isTrue(((JsonNode) root.get("Exif SubIFD")) != null);
