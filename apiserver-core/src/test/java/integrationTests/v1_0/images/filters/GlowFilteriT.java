...
public class GlowFilteriT extends HttpTest
{
    ...
    @Test
    public void testGlowFilterCache() throws Exception
    {
        throw new Exception("Not implemented yet");
    }
    ...
    @Test
    public void testGlowFilter() throws ServletException, IOException, Exception
    {
        int width = 500;
        int height = 296;
        String fileName = "IMG_5932_sm.png";
        String url = "/rest/v1/image/filters/glow";
