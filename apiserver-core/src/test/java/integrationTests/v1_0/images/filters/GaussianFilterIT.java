...
public class GaussianFilterIT extends HttpTest
{
    ...
    @Test
    public void testGaussianFilterCache() throws Exception
    {
        throw new Exception("Not implemented yet");
    }
    ...
    @Test
    public void testGaussianFilter() throws ServletException, IOException, Exception
    {
        int width = 500;
        int height = 296;
        String fileName = "IMG_5932_sm.png";
        String url = "/rest/v1/image/filters/gaussian";
