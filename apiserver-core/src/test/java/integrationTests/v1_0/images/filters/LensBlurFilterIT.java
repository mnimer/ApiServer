...
public class LensBlurFilterIT extends HttpTest
{
    ...
    @Test
    public void testLensBlurFilter() throws ServletException, IOException, Exception
    {
        int width = 500;
        int height = 296;
        String fileName = "IMG_5932_sm.png";
        String url = "/rest/v1/image/filters/lensblur";
