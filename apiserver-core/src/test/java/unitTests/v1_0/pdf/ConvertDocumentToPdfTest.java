...
@ContextConfiguration(locations = {
        ...
        "file:apiserver-core/src/main/webapp/WEB-INF/config/v1_0/flows/pdf/documentToPdf-flow.xml"})
public class ConvertDocumentToPdfTest
{
    public final Logger log = LoggerFactory.getLogger(ConvertDocumentToPdfTest.class);
