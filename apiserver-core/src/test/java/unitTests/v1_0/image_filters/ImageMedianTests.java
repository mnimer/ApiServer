...
public class ImageMedianTests
{
    ...
    {
        Future<Map> imageFuture = imageMedianFilterGateway.imageMedianFilter(defaultCacheId);
    ...
    {
        Future<Map> imageFuture = imageMedianFilterGateway.imageMedianFilter(file);
