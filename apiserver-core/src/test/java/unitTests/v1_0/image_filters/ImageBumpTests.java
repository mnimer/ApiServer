...
public class ImageBumpTests
{
    ...
    public void testBumpById() throws TimeoutException, ExecutionException, InterruptedException, IOException
    {
        ...
        Future<Map> imageFuture = imageBumpFilterGateway.imageBumpFilter(defaultCacheId, 1, true, matrix, false);
    ...
    {
        float[] matrix = new float[]{-1.0F,-1.0F,0.0F,-1.0F,1.0F,1.0F,0.0F,1.0F,1.0F};
        Future<Map> imageFuture = imageBumpFilterGateway.imageBumpFilter(defaultCacheId, 1, true, matrix, true);
    ...
    {
        float[] matrix = new float[]{-1.0F,-1.0F,0.0F,-1.0F,1.0F,1.0F,0.0F,1.0F,1.0F};
        Future<Map> imageFuture = imageBumpFilterGateway.imageBumpFilter(file, 1, true, matrix, false);
