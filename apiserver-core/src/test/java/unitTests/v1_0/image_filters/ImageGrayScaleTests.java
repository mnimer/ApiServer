...
public class ImageGrayScaleTests
{
    ...
    {
        Future<Map> imageFuture = imageGrayScaleFilterGateway.imageGrayScaleFilter(defaultCacheId);
    ...
    {
        Future<Map> imageFuture = imageGrayScaleFilterGateway.imageGrayScaleFilter(file);
