...
public class PdfCacheController
{
     ...
     * @return cache ID
     */
    @ApiOperation(value = "add an PDF document to the cache")
    ...
    public Callable<Map> addToCache(
     ...
     * @return cache ID
     */
    @ApiOperation(value = "update a PDF file in the cache")
    @RequestMapping(value = "/cache", method = {RequestMethod.PUT})
    public Callable<Map> updateCache(
     ...
     */
    @ResponseBody
    @ApiOperation(value = "get an PDF from cache")
     ...
     * @return
     */
    @ApiOperation(value = "delete/Remove an PDF file in cache")
    @RequestMapping(value = "/cache/{cacheId}", method = {RequestMethod.DELETE})
    public Callable<Boolean> deleteCache(
