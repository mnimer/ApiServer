 ...
 * Date: 9/16/13
 */
public class Url2PdfService
{
    public final Logger log = LoggerFactory.getLogger(Url2PdfService.class);
    ...
    public Object execute(Message<?> message) throws ColdFusionException
    {
        ...
        try
        {
            String cfcPath = pdfConfigMBean.getConvertUrlToPdfPath();
            String method = pdfConfigMBean.getConvertUrlToPdfMethod();
