 ...
 * Date: 9/18/12
 */
public class ImageManipulationColdFusionService
{
    ...
    public Object imageRotateHandler(Message<?> message) throws ColdFusionException
    {
        ...
        try
        {
            ...
            Object[] myArgs = {};
            Struct cfcResult = (Struct)myCFC.invoke("rotateImage", myArgs);
    ...
    public Object imageResizeHandler(Message<?> message) throws ColdFusionException
    {
        ...
        try
        {
            ...
            CFCProxy myCFC = new CFCProxy(cfcPath, false);
            Object[] myArgs = {};
            Struct cfcResult = (Struct)myCFC.invoke("resizeImage", myArgs);
            long end = System.currentTimeMillis();
